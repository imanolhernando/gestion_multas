...
public class AgenteDAO {
	...
	public Agente getById(long id) {
		...
		try (Connection conn = ConnectionManager.getConnection(); CallableStatement cs = conn.prepareCall(sql);) { // CREO
																													// OBJETO
																													// CONNECTION
	...
	// metodo getMultas para incluir todas las multas ANULADAS como elementos de un
	// arraylist
